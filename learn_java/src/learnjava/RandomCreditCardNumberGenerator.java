...
/*
	public static final String[] JCB_16_PREFIX_LIST = new String[] { "3088",
			"3096", "3112", "3158", "3337", "3528", "352", "353","354","355","356","357","358"};
	*/

	public static final String[] JCB_16_PREFIX_LIST = new String[] { "352", "353",
		"354","355","356","357","358"};

	public static final String[] JCB_15_PREFIX_LIST = new String[] { "2100",
			"1800" };

	public static final String[] DCI_14_PREFIX_LIST = new String[] { "30",
	"36", "38", "39"};
	
	public static final String[] NEWDISCOVER_14_PREFIX_LIST = new String[] { "9"};
	
	public static final String[] NEWDISCOVER_16_PREFIX_LIST = new String[] { "7"};
	...
	public static String generateJCB16CardNumber() {
		return credit_card_number(JCB_16_PREFIX_LIST, 16, 1)[0];
	}

	public static String[] generateJCB16CardNumber(int howMany) {
		return credit_card_number(JCB_16_PREFIX_LIST, 16, howMany);
	}
	
	public static String generateDCI14CardNumber() {
		return credit_card_number(DCI_14_PREFIX_LIST, 14, 1)[0];
	}

	public static String[] generateDCI14CardNumber(int howMany) {
		return credit_card_number(DCI_14_PREFIX_LIST, 14, howMany);
	}
	
	public static String[] generateNewdiscover14CardNumber(int howMany) {
		return credit_card_number(NEWDISCOVER_14_PREFIX_LIST, 14, howMany);
	}
	
	public static String[] generateNewdiscover16CardNumber(int howMany) {
		return credit_card_number(NEWDISCOVER_16_PREFIX_LIST, 16, howMany);
	}
	...
	/*	
		...
		*/
		...
		String[] creditcardnumbers = generateNewdiscover16CardNumber(howMany);
		for (int i = 0; i < creditcardnumbers.length; i++) {
			System.out.println(creditcardnumbers[i]
					+ ":"
					+ (isValidCreditCardNumber(creditcardnumbers[i]) ? "valid"
