...
public class LinkedinTest {
	...
	public LinkedinPageElements element = new LinkedinPageElements();

    @Test
	public void testcase(boolean skip) throws InterruptedException {

		// Thread.sleep(4000);
		browser.open("https://www.linkedin.com/contacts/?contacts_source=LinkedIn&filter=source");
		...
		String csv = directory.getParentFile() + "\\results\\linkedin_links_output.csv";
		try {
...
//		BufferedWriter out = new BufferedWriter(writer);
   ...
   @Test
    ...
    @BeforeClass
	public void login() {
		browser.open("https://www.linkedin.com/uas/login");

		browser.type(By.xpath(element.loginPage_emailid), "sudheer.test1@gmail.com");
		browser.type(By.xpath(element.loginPage_password), "password");

		browser.driver.findElement(By.xpath(element.loginPage_submit_btn)).submit();
		browser.waitForElement(By.xpath(element.loginPage_pagekey));
